...
fh = logging.FileHandler("/var/log/celery/task.log")
...
class TaskPool(BasePool):
    ...
    def on_start(self):
        ...
        #remeber pid for celery logging analysis
        self.pid = os.getpid()
    ...
    def grow(self, n=1):
        logger_task.info("anan: TaskPool-{} starts growing {} workers".format(self.pid, n))
        return self._pool.grow(n)

    def shrink(self, n=1):
        logger_task.info("anan: TaskPool-{} starts shrinking {} workers".format(self.pid, n))
